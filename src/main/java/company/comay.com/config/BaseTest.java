package org.exostar.config;

import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import com.relevantcodes.extentreports.LogStatus;
import org.exostar.config.extendreport.ExtentManager;
import org.exostar.config.extendreport.ExtentTestManager;
import org.exostar.config.extendreport.listner.AnnotationTransformer;
import org.exostar.config.extendreport.listner.TestListener;
...
public class BaseTest{
    ...
    public void beforeSuite(@Optional("false") boolean updateOnJira)throws Exception{
        ...
        if (jiraIntregration) {
            try {
                ...
                String cycleName = testCycleNamePreFix + df.format(dateobj);
    ...
    public void launchBrowser(ITestResult result, Method method, @Optional("chrome") String browserName) throws Exception{
